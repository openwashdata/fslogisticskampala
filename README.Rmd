...
## Example 1
A plot showing the collection locations of the truck with number plate "UAS 119X"
```{r}
library(fslogisticskampala)
library(ggplot2)
library(lubridate)
...
plants. The map below is shown as a static image, because GitHub does not
